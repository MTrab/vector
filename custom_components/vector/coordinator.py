...
class VectorDataUpdateCoordinator(DataUpdateCoordinator[Optional[datetime]]):
    ...
    def __init__(self, hass: HomeAssistant, entry: ConfigEntry) -> None:
        ...
        self.cubes: Cubes = hass.data[DOMAIN]["cubes"]
    ...
    async def leave_charger(self) -> None:
        ...
        # await self.robot.async_take_control(ControlPriorityLevel.DEFAULT_PRIORITY)
        await asyncio.wrap_future(
            self.robot.conn.request_control(ControlPriorityLevel.DEFAULT_PRIORITY)
        )
