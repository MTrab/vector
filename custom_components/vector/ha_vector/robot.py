...
from .messaging import protocol, external_interface_pb2
from .messaging.settings_pb2 import PullJdocsRequest
...
class Robot:
    ...
    # @on_connection_thread(requires_control=False)
    # async def get_version_state(self) -> protocol.VersionStateResponse:
    #     """Get Vector lifetime stats."""
    #     request = PullJdocsRequest()
    #     get_lifetime_stats_request = protocol.ROBOT_LIFETIME_STATS
    #     return await self.conn.grpc_interface.VersionState(get_version_state_request)
